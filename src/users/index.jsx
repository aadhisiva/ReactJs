...
function Users() {
    ...
    const getFormContent = () => {
        return (state.editForm && (
            (
            <DraggableDialog
            formData={state.data.find(element => element.id == state.editId)}
                            ...
                            (state.data || []).map((obj) => {
                                return (
                                    <TableRow key={obj.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                        ...
                                        <TableCell><IconButton style={{ color: "red" }} aria-label="delete" onClick={(e) => handleClick(obj.id)}>
                                            <Delete />
                                        </IconButton>
                                            <IconButton style={{ color: "blue" }} aria-label="edit" onClick={(e) => handleEditClick(obj.id)}>
                                                <Edit />
                                            </IconButton>
                                        </TableCell>
                                    </TableRow>
